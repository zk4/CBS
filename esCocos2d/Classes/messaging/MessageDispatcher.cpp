        ...
        std::vector<double > args)
{
    ...
    static  Telegram telegram (0, sender, receiver, msg, args);
...
void MessageDispatcher::DispatchMessageZZ (int receiver, int msg, std::vector<double > list)
{
    DispatchMessageZZ (0, receiver, receiver,msg,list);
}

void  MessageDispatcher::DispatchMessageZZ (int msg, std::vector<double > list)
{
